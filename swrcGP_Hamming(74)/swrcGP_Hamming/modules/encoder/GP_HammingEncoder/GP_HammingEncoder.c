...
void HammingEncoder(GP_HammingEncoderStruct *GP_HammingEncoder, int i, int N_input, uint8_t *input, uint8_t *output){


  //Using Bitwise XOR to check for even or odd number of 1s in input signal
  //Goal of hamming is to have even number of 1s
  //1^0=1
  //0^0=0
  //1^1=0

  //copy input bits to same index output bit
  for (i=0; i<N_input; i++){
